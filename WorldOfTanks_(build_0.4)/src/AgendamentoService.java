...
public class AgendamentoService {
    ...
    private static void adicionarTanquesPartida(Scanner scanner, Partida partida, CadastroService cadastroService, LocalDateTime dataHora, int duracao) {
        System.out.println("\n===== ADICIONAR TANQUES =====");
    ...
    // MÉTODO SIMPLIFICADO: Retorna todos os tanques ativos sem verificar conflitos complexos
